...
User.create(email: 'admin@student.cvtc.edu', encrypted_password: 'admin', admin: true)
User.create(email: 'user@student.cvtc.edu', encrypted_password: 'user', admin: false)