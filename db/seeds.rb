...
Ride.create(departlocation: 'Eau Claire', arrivelocation: 'Minneapolis', departtime: DateTime.new(2014,8,2,4), arrivetime: DateTime.new(2014,8,2,6), seatsavailable: '3', costperseat: '10', preferences: 'No Children', smoking: true, childtrueren: false)
